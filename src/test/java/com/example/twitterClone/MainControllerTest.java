...
public class MainControllerTest {
    ...
    public void addMessageToList() throws Exception{
        ...
        .andExpect(authenticated())
                ...
                .andExpect(xpath("//div[@id='message-list']/div[@data-id=8]").exists())
                .andExpect(xpath("//div[@id='message-list']/div[@data-id=8]/div/span").string("fifth"))
                .andExpect(xpath("//div[@id='message-list']/div[@data-id=8]/div/i").string("new one"));
    }
}
